  ...
  defaultCredentials: {
    ...
    description: {
      ...
      env:
        ...
        'Service IDs: `realdebrid`, `alldebrid`, `premiumize`, `debridlink`, `torbox`, `vps`, `torrin`, `offcloud`, `putio`, `easynews`, `easydebrid`, `debrider`, `pikpak`, `seedr`, `nzbdav`, `altmount`, `stremio_nntp`, `stremthru_newz`, `aiostreams`. ' +
