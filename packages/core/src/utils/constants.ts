...
> = {
  ...
  [VPS_SERVICE]: {
    ...
    shortName: 'VPS',
    knownNames: ['VPS', 'Self-Hosted VPS', 'Vps Debrid'],
    signUpText:
      'A self-hosted Debrid-style service running on your own VPS.',
    credentials: [
      {
        id: 'url',
        name: 'VPS Service URL',
        description:
          'The public HTTPS URL of your VPS Debrid service.',
        type: 'string',
        required: true,
      },
      {
        ...
        name: 'VPS API Key',
        description:
          'The API key configured in the VPS Debrid service.',
        type: 'password',
        required: true,
      },
    ],
